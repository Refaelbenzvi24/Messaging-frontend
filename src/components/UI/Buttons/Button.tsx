...
const style = 'rounded-lg dark:bg-transparent dark:hover:bg-gray-600 dark:active:bg-dark-200 '
	...
	+ 'focus:text-gray-900 hover:bg-gray-200 active:bg-gray-200 focus:outline-none focus:shadow-outline'
